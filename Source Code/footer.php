  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-contact">
            ...
            <p>
              ...
              <strong>Phone:</strong> +91- 7499866651<br>
              <strong>Phone:</strong> +91- 9579910370<br>
              <strong>Email:</strong> gawadedivya15@gmail.com<br>
              <strong>Email:</strong> sawantganesh96k@gmail.com<br>
            </p>
          </div>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span>Smart Farm</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
