...
?>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      <h1>Smart Farm - Change The Way You Trade...</h1>
      <h2>Smart Farm is to help farmers by providing all kinds agriculture related information in the website...</h2>
      ...
      <div class="container">
        ...
        <div class="row content">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
            ...
            <ul>
              <li><i class="ri-check-double-line"></i> ‘Smart Farm' is a model farmer management website application..</li>
              <li><i class="ri-check-double-line"></i> ‘Smart Farm’ provides a concept of virtual agricultural trade to its users.</li>
